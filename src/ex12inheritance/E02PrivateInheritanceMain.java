...
class Account{
	...
	protected void depsoitMoney(int _money) {
		if(_money<0) {
	...
	//private 멤버변수를 외부로 반환할떄 사용하는 메서드(getter)
...
class SavingAccount extends Account{
	...
	public void showAccountMoney() {
		/*
		 ...
		 할 수 없으므로 아래와 같이 getter메서드로 반환받아 출력해야 한다.
		 */
...
//		sa.money = 10000; 에러발생
		...
		/*
		 ...
		 변수를 통해서도 money에 접근할 수 없다. 현대의 위치가 외부 
		 클래스이기 떄문이다. 즉 private 멤버는 무조건 클래스 내부에서만
		 접근을 허용한다.
		 */
