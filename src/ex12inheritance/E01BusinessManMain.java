...
/*
  2개의 클래스가 상속관계에 있을떄 가장 기본이 되는 코드는 아래와 같다.
...
/*
 ...
 정의하는 것을 말한다. 부모클래스를 자식클래스가 상속할떄 extends를 사용한다.
 */
...
class BusinessMan extends Man{
	...
	public BusinessMan(String name,String company,String position) {
		/*
		 ...
		 메모리에 먼저 생성되도록 해야한다. super()는 부모클래스이
	...
	public void tellYourInfo() {
		...
		/*
		 ...
		 상속박은 자식클래스에 접근할 수 없다. private멤버는 무조건
