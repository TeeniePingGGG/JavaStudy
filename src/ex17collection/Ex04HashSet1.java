...
public class Ex04HashSet1 {
	...
	public static void main(String[] args) {
		...
		int varInt = 100; //저장시 Integer Boxing 처리됨 
		Teacher varTeacher = new Teacher("김봉두", 55, "체육");
		
		/*
		 인스턴스(객체)저장: add() 메서드를 통해 저장한다. 저장에 성공한
		 	경우 true를 반환한다.
		 */
		...
		/*
		 기본클래스의 객체 중복저장
		 : 기본클래스의 인스턴스인 경우 별도의 오버라이딩 없이도 중복이
