...
//과일상자: Object기반으로 모든 과일 인스턴스을 저장할 수 있는 상자
class FruitBox{
	Object item; //멤버변수: 모든 인스턴스 저장 가능
...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 오렌지 박스 인스턴스와 당도가 10인 오렌지 인스턴스를
		 생성한 후 상자에 저장
		 */
...
//		oBox1.store("당도가 20인 오렌지");
		...
		/*
		 Object를 기반으로 생성된 FruitBox는 구현에는 편라하나
		...
		/*
		 하지만 오렌지 같은 String을 저장하고, 이를 꺼내서 다운 캐스팅하는
		 과정에서 예외가 발생된다. 즉 런타임 에러가 발생하게 되므로
