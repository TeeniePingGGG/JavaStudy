...
public class Ex07AsList {
	...
	public static void main(String[] args) {
		...
		/*
		 String 타입의 배열을 생성과 동시에 초기화. 이 경우 초기화
		 데이터의 갯수를 통해 크기를 유추할 수 있으므로, 크기가 4인
		 배열이 생성된다.
		 */
		...
		/*현재상태에서는 데이터 추가가 불가능 하므로 런타임에러가
		발생된다*/
//		list.add("탱크"); //에러발생
		
		/*
		 ArrayList<E>의 생성자를 통해 인스턴스를 복사라면 데이터
		 변경을 할 수 있다.
		 */
		...
		/*
		 ...
		 next()가 증감식을 대체할 수 있으므로 아래와 같이 작성할 수
		 있다.
		 */
