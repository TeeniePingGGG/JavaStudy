...
public class Ex06HashMapMain {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println("name이라는 키값으로 지정된 이전의 값:"
						+map.put("name", "홍길동"));
...
//		map.put("age", number);
		...
		/*
		 ...
		 수정된다 */
		System.out.println("name이라는 키깂으로 저장된 이전의 값:"+
				map.put("name", "최길동"));
		...
		/*
		 2. 키값을 모를때(혹은 너무 많아서 명시하기 힘들떄)
		 : keySet()을 통해 전체 key를 Set으로 얻어온다
		 이 값을 통래 반복문으로 접근하여 value를 인출할 수 있다.
		 */
