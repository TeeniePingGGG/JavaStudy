...
//		ArrayList<String> list2 = new ArrayList<String>();
		...
		/*
		 ...
		 갯수를 반환받을 수 있다. 인덱스로 접근해야하므로 get()
		 메서드를 사용한다.*/
		...
		/*
		 ...
		 반환할 원소가 있는지 확인 후 true이면 next()로 인출한다.
		 */
		...
		/*
		 ...
		 있는 코드를 작성하시오. 이때 반복문은 확장 for문을 사용하시오.
		 */
		int idx = 0;
		...
		for(Student st:list2) {
			/*
			 ...
			 이름돠 Student인스턴스에 저장된 name과 일치하는지 확인
		...
		/*
		 앞에서 지운 인스턴스에 따라 아래의 결과는 달라질 수 잇다.
