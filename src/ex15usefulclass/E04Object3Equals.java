...
class MyClass{
	...
	public String toString() {
		return "data="+String.valueOf(data); //정수를 String으로 변경해서 반환한다.
		//이런 방법도 있다.
		//return ""+data
	}
	/*
	 MyClass 인스턴스간의 내용비교를 위해 equlas() 를 오버라이딩하여
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof MyClass) {
			/*
			 ...
			 그렇지않으면 부모타입으로는 자식 멤버에 접근할 수 없으므로
			 멤버변수에 대한 비교가 불가능한다. */
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 단, 오버라이딩 해놓은 equals() 삭제한 후 비교하면 다르다는
