...
/*
 Wrapper 클래스: 기본자료형의 데이터를 인스턴스화 할떄 사용하는 클래스로
 	Boxing/unboxing을 통해 기본자료형의 데이터를 인스턴스화 한다.
 	뒤에서 학습랑 제네릭 클래스에 필수적으로 사용된다.
 */
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		/*
		 JDK에서 최신버전에서는 디플리케이트 되어 사용되지 않는 생성자라는
		 경고 메서지가 출력된다. 구 버전과의 호환성을 위해 남겨져있는 
		 상태이다. */
		//정수를 구 버전의 생성자를 이용해서 Boxing처리
		Integer n10Obj = new Integer(10);
		Integer n20Obj = new Integer(num2);
		//메서드를 통해 Unboxing 후 뎃셈 연산을 진행
