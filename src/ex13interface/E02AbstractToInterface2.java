...
class PersonalNumberStorageImpl implements PersonalNumberStorage
{
		...
		public void addPersonalInfo(String juminNum, String name) {
			...
			numOfPerInfo++; //인덱스로 사용한 변수를 1 증가
		}
		...
		public String searchPersonalInfo(String juminNum) {
			...
			for(int i=0; i<numOfPerInfo; i++) {
				...
				if(juminNum.compareTo(personalArr[i].getJuminNum())==0) {
					...
					/*
					 DTO의 멤버변수 private으로 선언되었으므로 외부에서는
...
public class E02AbstractToInterface2 {
	...
	public static void main(String[] args) {
		...
		//2개의 정보를 추가
		storage.addPersonalInfo("901234-22222", "김태희");
		storage.addPersonalInfo("9012434-11111", "정지훈");
		
		//정보를 검색
		System.out.println(storage.searchPersonalInfo("901234-22222"));
		System.out.println(storage.searchPersonalInfo("9012434-11111"));
		System.out.println(storage.searchPersonalInfo("1111111-1111111"));
	}
