...
/*
 ...
 - 추상클래스와 동일하게 상속을 목적으로 제작되므로 구현받은 하위 클래스에서는
 반드시 추상메서드를 오버라이딩 해야한다
 - 멤버로는 추상메서드와 상수만 선언할 수 있다. 	
 	메서드: public abstract
 	상수: public static final
 - 인터페이스는 생성자를 선언할 수 있다.
 */

interface MyInterface1{
//	public MyInterface1() {} 생성자 선언 불가
	...
	/*
	 멤버메서드: 메서드는 선언시 추상메서드가 된다. 따라서 public abstract는
	 생략하는것이 좋다.
	 */
...
class MyClass extends SimpleClass 
	...
	/*
	 SimpleClass 클래스는 멤버메서드는 오버라이딩이 필수가 아니므로
	 필요한 경우에만 추가하면 된다.
	 */
}
