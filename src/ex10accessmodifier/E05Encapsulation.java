...
class EncapsulLogic{
	...
	void doProcess() {
		memberRegister.doMemberRegister();//가입
		autoLogin.doAutoLogin();//로그인
		congratulationPoint.doCongratulationPoint();//포인트
		firstLoginEvent.doFirstLoginEvent();//이벤트 페이지
	}
}
...
public class E05Encapsulation {
	...
	public static void main(String[] args) {
		...
		memberRegister.doMemberRegister();
