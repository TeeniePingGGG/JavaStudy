...
public class Ex02PreDefineException1 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 발생되먄 JVM(자바가상머신)은 해당 예외에 관련된 인스턴스를
		 만들어 프로그램쪽으로 전달한다.
		 이떄 catch절에서 예외 인스턴스를 잡아주는것을 "예외처리"
		 라고 한다.
		...
		try {
			...
			/*
			 예외가 발생하는 지점.
			 해당 코드가 실행될떄 예외가 발생하게되고 JVM이 예외
			...
			/*
			 JVM이 throw한 예외 인스턴스를 catch절에 잡아
			 처리한다. 그러면 예외가 발생되어도 프로그램의 실행은
			 유지된다. */
			//예외메세지1: 개발자가 임의로 메세지를 출력
			System.out.println("예외가 발생했엉");
