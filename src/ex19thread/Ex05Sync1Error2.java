...
//	}
	...
	/*
	 ...
	 해당 프로그램에서는 실행코드가 1줄박에 없으므로 동기화 방법에
	 대한 성능차이가 없다. 하지만 실행코드가 많은 경우 메서드 전체를
	 동기화 하는것보다 필요한 크로드만 동기화하는 '동기화블럭'이
	 훨씬 더 좋은 성능을 보이게 된다.
	 */
...
class MultiAdderThread2 extends Thread{
	...
	/*
	 ...
	 이 경우 동기화 처리가 되지 않아 동시에 접근되는 경우가
